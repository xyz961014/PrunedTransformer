...
gradient_accumulation_steps_phase2=${20:-1}
CODEDIR=${21:-"/workspace/bert"}
DATA_DIR=${22:-"/data"}
DATASET=hdf5_lower_case_1_seq_len_512_max_pred_80_masked_lm_prob_0.15_random_seed_12345_dupe_factor_30/books_wiki_en_corpus
DATA_DIR_PHASE1=${23:-$DATA_DIR/${DATASET}/}
BERT_CONFIG=$CODEDIR/bert_mini_config.json
DATASET2=hdf5_lower_case_1_seq_len_512_max_pred_80_masked_lm_prob_0.15_random_seed_12345_dupe_factor_30/books_wiki_en_corpus
DATA_DIR_PHASE2=${24:-$DATA_DIR/${DATASET2}/}
init_checkpoint=${25:-"None"}
RESULTS_DIR=${26:-"/results/nvidia_bert"}
