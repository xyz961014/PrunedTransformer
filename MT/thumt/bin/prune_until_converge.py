...
def parse_args(args=None):
    ...
    parser.add_argument("--dim_prune_threshold", type=float, default=0.2,
                        help="BLEU threshold to consider model has recovered")
                ...
                if step % params.eval_steps == 0:
                    ...
                    if target_score == 0 or target_score - eval_score <= args.dim_prune_threshold:
                        ...
                        if dist.get_rank() == 0:
                            ...
                            print_variables(model, params.pattern, True)
                    start_time = time.time()
